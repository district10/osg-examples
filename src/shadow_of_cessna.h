 ...
 * Cast the shadow of models to the ground using osgShadow NodeKits
*/
...
int shadow_of_cessna_main( int argc, char** argv )
{
    ...
    // Set the dumptruck (receives and casts shadow)
