 ...
 * Changing thread models to render multiple scenes in different behaviors
*/
...
int thread_models_main( int argc, char** argv )
{
    osg::ArgumentParser arguments( &argc, argv );
    
    osgViewer::ViewerBase::ThreadingModel th = osgViewer::ViewerBase::AutomaticSelection;
    ...
    else if ( arguments.read("--drawPerContext") ) th = osgViewer::ViewerBase::DrawThreadPerContext;
