 ...
 * Drawing a quad with dynamically moving vertices
*/
...
int dynamic_geometry_main( int argc, char** argv )
{
    osg::Geometry* quad = dynamic_geometry::createQuad();
